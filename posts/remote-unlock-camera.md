...
> [TIP]
> Bài viết này tập trung vào việc vượt qua màn hình khóa (Pattern) bằng lệnh shell. Hãy đảm bảo bạn đã thiết lập thành công `rish` theo hướng dẫn [Kết nối Terminal với Shizuku](https://hgblog.netlify.app/post.html?id=termux-shizuku-control "Kết nối Terminal với Shizuku") trước khi bắt đầu.
